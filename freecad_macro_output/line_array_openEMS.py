...
mesh.x = np.delete(mesh.x, np.argwhere((mesh.x >= -5) & (mesh.x <= 53)))
mesh.x = np.concatenate((mesh.x, arangeWithEndpoint(-5,53,1.2)))
mesh.y = np.delete(mesh.y, np.argwhere((mesh.y >= -5) & (mesh.y <= 175)))
mesh.y = np.concatenate((mesh.y, arangeWithEndpoint(-5,175,1.2)))
...
mesh.x = np.delete(mesh.x, np.argwhere((mesh.x >= 4.975) & (mesh.x <= 42.3)))
mesh.x = np.concatenate((mesh.x, arangeWithEndpoint(4.975,42.3,0.6)))
mesh.y = np.delete(mesh.y, np.argwhere((mesh.y >= 0) & (mesh.y <= 154.3)))
mesh.y = np.concatenate((mesh.y, arangeWithEndpoint(0,154.3,0.6)))
...
mesh.x = np.delete(mesh.x, np.argwhere((mesh.x >= 0) & (mesh.x <= 48)))
mesh.x = np.concatenate((mesh.x, arangeWithEndpoint(0,48,0.6)))
